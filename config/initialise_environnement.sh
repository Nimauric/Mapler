...
mamba create -p ~/my_env flye=2.9.1 canu=2.2 xmlstarlet=1.6.1 snakemake=7.20.0 pandas=1.5.3 quast=5.2.0 minimap2=2.24 miniasm=0.3_r179 fastqc=0.11.9 sra-tools=2.8.0 samtools=1.15 rasusa=0.7.0 r=4.2 hifiasm_meta=0.3-r063.2 -y
